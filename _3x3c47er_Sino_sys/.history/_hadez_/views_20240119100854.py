...
# system navs
def x8(request):
    return render(request, "xlanding.html")
...
# system navs
def x11(request):
    return render(request, "temp_access_student.html")


# system navs
def x12(request):
    return render(request, "xactive.html")
...
# system navs
def x14(request):
    return render(request, "sys_major.html")
